...
Future<Map> fetchAccessToken(String username, String senha) async {
  try {
    ...
    var url =
        'https://ws.audioscrobbler.com/2.0/?method=auth.getMobileSession&username=${data['username']}&password=${data['password']}&api_key=f62a2d2d3a59bc0a79c85e8f04e18b8b&api_sig=${sigmd5}';
